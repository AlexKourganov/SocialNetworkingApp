...
export default function (state = initialState, action) {
  switch (action.type) {
    ...
    case SUBMIT_COMMENT:
      let updateCommentCount = state.screams.findIndex(
        (scream) => scream.screamId === action.payload.screamId
      );
      state.screams[updateCommentCount].commentCount =
        state.screams[updateCommentCount].commentCount + 1;
      return {
        ...state,
        scream: {
          ...state.scream,
    ...
    case DELETE_SCREAM:
      ...
      let deleteIndex2 = state.renderScreams.findIndex(
        (scream) => scream.screamId === action.payload
      );
